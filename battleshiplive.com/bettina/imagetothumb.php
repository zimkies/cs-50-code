...
move_uploaded_file ($file_tmp, "1$rand_name.$file_ext");
/*
...
echo "IMG:<img src=\"$rand_name.$file_ext\" />";
exit();
//*/
//and you should be set!
//success message, redirect to main page.		
$msg = urlencode("$title was uploaded! <a href=\"tester3.php\">Upload More?</a>");
header("Location: tester3.php?msg=$msg");
exit();
}else{
